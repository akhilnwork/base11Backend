...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <h2 class="text-2xl font-bold text-gray-900">Create Gallery</h2>
    ...
    <div class="bg-white shadow rounded-lg">
        <form action="{{ route('admin.galleries.store') }}" method="POST" class="space-y-6 p-6">
            @csrf
            ...
            <div>
                ...
                <div class="mt-1">
                    <textarea name="description" id="description" rows="3" 
                              ...
                              placeholder="Enter gallery description (optional)">{{ old('description') }}</textarea>
                </div>
                @error('description')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <div class="mt-1">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Choose multiple images for the gallery</p>
                </div>
            ...
            <div class="space-y-4">
                <div class="flex items-center">
                    <input type="checkbox" name="view_in_gallery" id="view_in_gallery" value="1" {{ old('view_in_gallery', true) ? 'checked' : '' }}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Global handleGalleryImagesSelection function:', typeof window.handleGalleryImagesSelection);
    ...
    window.handleGalleryImagesSelection = function(media) {
        console.log('=== GALLERY IMAGES SELECTION START ===');
        ...
        if (media.length > 0) {
            galleryImageIds = media.map(item => item.id);
            updateGalleryImagesDisplay(media);
            updateGalleryImagesInputs();
            console.log('Gallery images selected:', galleryImageIds);
        } else {
            console.error('Empty gallery images array received');
        }
        
        console.log('=== GALLERY IMAGES SELECTION END ===');
    };
    ...
    function updateGalleryImagesDisplay(images) {
        ...
        if (images.length > 0) {
            ...
            selectImagesBtn.textContent = 'Select Gallery Images';
        }
    }
