...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <h2 class="text-2xl font-bold text-gray-900">Edit About Slide</h2>
    ...
    <div class="bg-white shadow rounded-lg">
        <form action="{{ route('admin.about-slides.update', $aboutSlide) }}" method="POST" class="space-y-6 p-6">
            @csrf
            @method('PUT')
            ...
            <div>
                <label for="title" class="block text-sm font-medium text-gray-700">Title</label>
                                    <div class="mt-1">
                        <input type="text" name="title" id="title" value="{{ old('title', $aboutSlide->title) }}" 
            ...
            <div>
                <label for="order" class="block text-sm font-medium text-gray-700">Order</label>
                                    <div class="mt-1">
                        <input type="number" name="order" id="order" value="{{ old('order', $aboutSlide->order) }}" min="0"
            ...
            <div>
                ...
                <div class="mt-1">
                    <div id="imagePreview" class="{{ $aboutSlide->image ? '' : 'hidden' }} mb-4">
                        <div class="relative inline-block">
                            <img id="selectedImage" 
                                 src="{{ $aboutSlide->getImageThumbUrl() ?: ($aboutSlide->getImageUrl() ?: '') }}" 
                    ...
                    <button type="button" id="selectImageBtn" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        ...
                        {{ $aboutSlide->image ? 'Change Image' : 'Select Image' }}
                    </button>
                    
                    <input type="hidden" name="image_id" id="imageId" value="{{ old('image_id', $aboutSlide->image_id) }}">
            ...
            <div class="flex items-center">
                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $aboutSlide->is_active) ? 'checked' : '' }}
